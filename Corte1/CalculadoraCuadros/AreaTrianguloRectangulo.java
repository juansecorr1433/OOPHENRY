public class AreaTrianguloRectangulo extends CalculoGeometrico {
    public AreaTrianguloRectangulo(Numero base, Numero altura) {
    ...
    public Numero calcular() {
        ...
        return new Numero((base * altura) / 2.0);
    }
}